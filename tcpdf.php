...
class TCPDF {
	...
	public function Output($name='doc.pdf', $dest='I') {
		...
		if ($this->sign) {
            ...
            require_once(dirname(__FILE__).'/include/tcpdf_signature.php');
            $tcpdf_cms = new TCPDF_SIGNATURE($this->signature_data, $this->signature_data_ltv, $this->signature_data_tsa);
            $signature = $tcpdf_cms->pkcs7_sign($pdfdoc);
