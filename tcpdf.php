...
if (!class_exists('TCPDF', false)) {
	...
	*/
	...
	Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		 ...
		 * @paramboolean $correct_align if true correct the number alignment (numbers must be in monospaced font like courier and right aligned on LTR, or left aligned on RTL)
		 * @access public
		 * @author Nicola Asuni
		 * @since 5.0.001 (2010-05-06)
