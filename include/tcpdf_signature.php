...
class TCPDF_SIGNATURE {
  ...
  public $signature_data_tsa = array();
     ...
     * @public
     */
  public function __construct($signature_data, $signature_data_ltv, $signature_data_tsa) {
      $this->log .= "info:Start PKCS7 Signing...\n";
      $this->signature_data = $signature_data;
      $this->signature_data_ltv = $signature_data_ltv;
      $this->signature_data_tsa = $signature_data_tsa;
  }
  ...
  public function pkcs7_sign($binaryData) {
    ...
    $this->log .= "info:PDF Sign Finish size \"".strlen($pkcs7ContentInfo)."\" Kb\n";
