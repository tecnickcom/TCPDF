...
// ====================================================================================================================
    ...
    {
        if ($isunicode) {
            return array_map(['IXCTCPDF_FONTS', 'unichrUnicode'], $ta);
        }
        return array_map(['IXCTCPDF_FONTS', 'unichrASCII'], $ta);
    }
    ...
    public static function UTF8StringToArray($str, $isunicode, &$currentfont)
    {
        if ($isunicode) {
            ...
            $carr = array_map(['IXCTCPDF_FONTS', 'uniord'], $chars);
        } else {
            $chars = str_split($str);
    ...
    public static function utf8Bidi($ta, $str, $forcertl, $isunicode, &$currentfont)
    {
        ...
        for ($i = 0; $i < $numchars; ++$i) {
            if ($ta[$i] == IXCTCPDF_FONT_DATA::$uni_RLE) {
                ...
                if ($next_level < 62) {
                    $remember[] = ['num' => IXCTCPDF_FONT_DATA::$uni_RLE, 'cel' => $cel, 'dos' => $dos];
                    $cel = $next_level;
                    $dos = 'N';
                    $sor = $eor;
                    $eor = $cel % 2 ? 'R' : 'L';
                ...
                if ($next_level < 62) {
                    $remember[] = ['num' => IXCTCPDF_FONT_DATA::$uni_LRE, 'cel' => $cel, 'dos' => $dos];
                    $cel = $next_level;
                    $dos = 'N';
                    $sor = $eor;
                    $eor = $cel % 2 ? 'R' : 'L';
                ...
                $next_level = $cel + ($cel % 2) + 1;
                if ($next_level < 62) {
                    $remember[] = ['num' => IXCTCPDF_FONT_DATA::$uni_RLO, 'cel' => $cel, 'dos' => $dos];
                    $cel = $next_level;
                    $dos = 'R';
                    $sor = $eor;
                    $eor = $cel % 2 ? 'R' : 'L';
                ...
                $next_level = $cel + 2 - ($cel % 2);
                if ($next_level < 62) {
                    $remember[] = ['num' => IXCTCPDF_FONT_DATA::$uni_LRO, 'cel' => $cel, 'dos' => $dos];
                    $cel = $next_level;
                    $dos = 'L';
                    $sor = $eor;
                    $eor = $cel % 2 ? 'R' : 'L';
